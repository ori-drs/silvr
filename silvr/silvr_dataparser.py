...
@dataclass
class LidarDepthNormalDataParserConfig(NerfstudioDataParserConfig):
    """Data parser config for Nerfstudio data with lidar depth and normal images."""

    _target: Type = field(default_factory=lambda: LidarDepthNormalDataParser)


@dataclass
class LidarDepthNormalDataParser(Nerfstudio):
    """Data parser for Nerfstudio data with lidar depth and normal images."""
