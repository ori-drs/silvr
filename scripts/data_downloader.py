...
class HFDatasetManager:
    def __init__(self, hf_repo_id: str, local_base_dir: str = "data", token: str = None):
    ...
    def download(self, pattern: str):
        ...
        zip_files = list((self.local_base_dir).rglob("*.zip"))
...
if __name__ == "__main__":
    ...
    local_dir = "/home/docker_dev/silvr/data"
    silvr_hf_repo_id = "ori-drs/silvr_data"
    downloader = HFDatasetManager(silvr_hf_repo_id, local_dir)
    downloader.download(pattern="2024-03-13-roq-01-tro.zip")
    downloader.download(pattern="2024-bodleian-01+02-tro.zip")
